...
SECRET_KEY = 'django-insecure-8dvlye%g125zil(v4iksab24a551@mr7h1y^x1%@ipjbc-!qen'
...
INSTALLED_APPS = [
    ...
    'blog_auth',  # Include the blog_auth app
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'django.templatetags.static',  # For static files in templates
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('database', 'blog_django'),
